...
public class DMMessagesImpl implements DMMessages, ExceptionListener {
    ...
    public DMMessagesImpl(Hierarchy hierarchy) {
        ...
        try {
            ...
            for (String topic : allTopics) {
                ...
                Listener listener = new Listener(topic, sender, hierarchy);
    ...
    private static class Listener implements MessageListener {
        ...
        private final MonitorMessages sender;

        private final String topic;

        private Hierarchy hierarchy;

        public Listener(String topic, MonitorMessages sender, Hierarchy hierarchy) {
            super();
            this.topic = topic;
            this.sender = sender;
